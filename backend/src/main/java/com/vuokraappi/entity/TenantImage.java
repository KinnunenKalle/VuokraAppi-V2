...
public class TenantImage {
    ...
    /**
     * Polku Azure Blob Storagessa, esim. "{tenantId}/{imageId}.jpg"
    ...
    /**
     * Onko tämä vuokralaisen profiilikuva.
     * Vain yksi kuva per vuokralainen voi olla primary – tämä varmistetaan servicessä.
     */
